        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinationMasked = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExportedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PasswordExports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PasswordExports_PasswordEntries_PasswordEntryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PasswordEntryId = table.Column<int>(type: "int", nullable: false),
                    OldEncryptedPassword = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordExports_PasswordEntryId",
                table: "PasswordExports",
